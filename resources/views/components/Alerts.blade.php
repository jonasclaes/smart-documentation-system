@if(session('success'))
    <div id="alert" class="bg-green-600-500-900 text-center py-4 lg:px-4">
        <div onclick="closeAlert(event)"
             class="p-2 bg-green-600 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
             role="alert">
...
@if(session('error'))
    <div id="alert" class="bg-red-600-500-900 text-center py-4 lg:px-4">
        <div onclick="closeAlert(event)"
             class="p-2 bg-red-600 items-center text-indigo-100 leading-none lg:rounded-full flex lg:inline-flex"
             role="alert">
            <span class="flex rounded-full bg-red-600 uppercase px-2 py-1 text-xs font-bold mr-3">Info</span>
