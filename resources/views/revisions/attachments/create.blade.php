...
@section('content')
    ...
    <div class="container mx-auto px-3">
        ...
        <div class="bg-white rounded-xl p-4 w-full mb-3">
            <h1 class="text-xl font-semibold">{{ __('Upload attachment') }}</h1>
        </div>
            ...
            <form action="{{ route('revisions.attachments.store', [$file, $revision]) }}" method="POST" id="createForm" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
                    <x-forms.input-block.file
                        label="Attachment:"
                        name="file"
                        helpText="Select the file to be uploaded here.">
                    </x-forms.input-block.file>
                    <div>
                        ...
                        <small class="opacity-50">{{ __('Select the revision the attachment belongs to here.') }}</small>
                        @error('fileId')
                        <br>
